<template class="a">
  ...
  >
      <div class="container col-sm-12 col-md-12 mt-5 mb-5">
        <div class="row ">
          ...
          <div class="col-sm-12 col-md-12 mt-5 mb-5">
            <p class="message__text">
              ...
              <br>
              Pulsa sobre la imagen para regresar al inicio
            </p>
          </div>
        </div>
      </div>
...
.fondo {
  ...
  background: radial-gradient(at 50% 50%, #2f2242, #d65b5b) fixed;
}
...
.message__text {
  font-family: Impact, monospace, system-ui, 'Segoe UI', 'Open Sans', 'Helvetica Neue';
  font-size: 20px;
  margin: auto;
}

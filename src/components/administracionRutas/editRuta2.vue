                            ...
                            <q-item v-for="(parada, index) in this.ruta.ida.paradas" :key="index">
                                ...
                                <q-item-section side>
                                    <div class="text-grey-8 q-gutter-xs">
                                        <q-btn flat dense round icon="fas fa-solid fa-caret-up" @click="intercambiarParadasIda(parada, 'up')" size="12px" ></q-btn>
                                        <q-btn flat dense round icon="fas fa-solid fa-caret-down" @click="intercambiarParadasIda(parada, 'down')" size="12px" ></q-btn>
                                        <q-btn flat dense round icon="delete" size="17px" @click="eliminarParadaIda(parada)"></q-btn>
                                    </div>
                                </q-item-section>
                            </q-item>
                        </q-list>
                    ...
                    <q-tab-panel name="vuelta">
                        ...
                        <q-list v-if="hasParadasVuelta()" dense bordered padding class="rounded-borders text-black">
                            <q-item v-for="(parada, index) in this.ruta.vuelta.paradas" :key="index">
                                ...
                                <q-item-section side>
                                    <div class="text-grey-8 q-gutter-xs">
                                        <q-btn flat dense round icon="fas fa-solid fa-caret-up" @click="intercambiarParadasVuelta(parada, 'up')" size="12px" ></q-btn>
                                        <q-btn flat dense round icon="fas fa-solid fa-caret-down" @click="intercambiarParadasVuelta(parada, 'down')" size="12px" ></q-btn>
                                        <q-btn flat dense round icon="delete" size="17px" @click="eliminarParadaVuelta(parada)"></q-btn>
                                    </div>
                                </q-item-section>
                            </q-item>
                        </q-list>
